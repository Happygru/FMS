    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3>@lang('fleet.income') @lang('fleet.report')@lang('fleet.third')&nbsp;<small>{{date('F', mktime(0, 0, 0, $month_select, 10))}}-{{$year_select}}</small></h3>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td>
                      @if($row->vehicle_id != null)
                      {{Hyvikk::get('currency')}} {{$row->thirdparty_amount}}
                      @endif
                    </td>
                    <td>{{$row->mileage}}</td>
                </tr>
