...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        {!! Form::open(['url' => 'admin/reports/thirdparty_expense','method'=>'post','class'=>'form-inline']) !!}
        <div class="row">
          ...
          <button type="submit" formaction="{{url('admin/print-thirdparty-expense')}}" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> @lang('fleet.print')</button>
        </div>
        {!! Form::close() !!}
      </div>
    </div>
    ...
    <div class="card card-info">
      ...
      <div class="card-body table-responsive">
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          <thead>
            <tr>
              <th>@lang('fleet.partner') @lang('name')</th>
          ...
          @foreach($expense as $row)
            <tr>
              ...
              {{Hyvikk::get('currency')}}
              {{$row->amount}}</td>
              <td>{{Hyvikk::get('currency')}} {{$row->thirdparty_amount}}</td>
              <td>{{$row->comment}}</td>
            </tr>
          @endforeach
          </tbody>
