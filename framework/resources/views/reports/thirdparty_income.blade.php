...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        {!! Form::open(['url' => 'admin/reports/thirdparty_income','method'=>'post','class'=>'form-inline']) !!}
        <div class="row">
          ...
          <button type="submit" formaction="{{url('admin/print-thirdparty-income')}}" class="btn btn-danger" style="margin-right: 10px"><i class="fa fa-print"></i> @lang('fleet.print')</button>
        </div>
        {!! Form::close() !!}
      </div>
    </div>
