...
<li class="breadcrumb-item active">@lang('fleet.edit_lead')</li>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <a class="btn btn-danger" href="{{url('admin/crm-leads')}}">
