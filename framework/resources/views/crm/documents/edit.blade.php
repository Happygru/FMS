...
<li class="breadcrumb-item active">@lang('fleet.edit_document')</li>
@endsection
@section('content')
<div class="row">
            ...
            <div class="card-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="@lang('fleet.name')" id="name" value="{{$document->name}}" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">@lang('fleet.description')</label>
                        <input type="email" placeholder="@lang('fleet.email')" id="email" class="form-control" value="{{$document->description}}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="icon_file_select_form">
                            <input type="text" class="form-control" placeholder="@lang('fleet.documents')" value="{{$document->attach}}" id="document" disabled />
                        ...
                        <a href="{{asset('uploads/corporate_documents/'.$document->attach)}}" download>{{$document->attach}}</a>
                    </div>
                    <div>
...
<script>
    ...
    function create() {
        ...
        $.ajax({
            url: "{{url('admin/crm-documents/edit')}}",
            type: "POST",
            data: formData,
