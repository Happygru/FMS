  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('VehicleGroup add')<a href="{{ route('vehicle_group.create')}}" class="btn btn-success" title="@lang('fleet.createGroup')"><i class="fa fa-plus"></i></a>@endcan</h3>
      </div>
      ...
      <div class="card-body table-responsive">
        <table class="table" id="ajax_data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @can('VehicleGroup delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled title="@lang('fleet.delete')" ><i class="fa fa-trash"></i></button>@endcan
              </th>
              <th>@lang('fleet.groupName')</th>
              <th>@lang('fleet.description')</th>
              <th>@lang('fleet.vehicles')</th>
