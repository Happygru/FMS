...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item active">@lang('fleet.my_vehicles')</li>
@endsection
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">@lang('fleet.manageVehicles') &nbsp; @can('Vehicles add')
                            <a href="{{ url('admin/thirdvehicles/create') }}" class="btn btn-success btn-sm" title="@lang('fleet.addNew')"><i class="fa fa-plus"></i></a>
                        @endcan
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/thirdvehicles-fetch') }}",
                    type: 'POST',
                    data: {}
                },
                columns: [{
