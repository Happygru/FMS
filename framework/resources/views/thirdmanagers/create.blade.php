...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item"><a href="{{ route('thirdmanagers.index')}}">@lang('fleet.users')@lang('fleet.third')</a></li>
<li class="breadcrumb-item active"> @lang('fleet.addUser')@lang('fleet.third')</li>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="card card-info">
            <div class="card-header with-border">
                <h3 class="card-title">
                  @lang('fleet.addUser')@lang('fleet.third')
                </h3>
            </div>
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <a class="btn btn-danger" href="{{url('admin/thirdmanagers')}}">
...
<script>
    ...
    function create() {
        ...
        $.ajax({
            url: "{{route('thirdmanagers.ajax_store')}}",
            type: "POST",
            data: formData,
