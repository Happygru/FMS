      ...
      <div class="card-body">
        ...
        <div class="step step-4">
          ...
          <div class="row step_button_group">
            ...
            <button class="btn btn-info" onclick="save_booking()"><i class="fa fa-paper-plane"></i> @lang('fleet.approve') </button>
          </div>
        </div>
      </div>
    </div>
...
@section('script')
  ...
  <script>
    ...
    function save_booking() {
      ...
      postData.append('booking_id', '{{$booking_detail->booking_id}}');
