      ...
      <div class="card-body">
        ...
        <div class="step step-4">
          ...
          <div class="row step_button_group">
            ...
            <button class="btn btn-info" onclick="save_booking()"><i class="fa fa-paper-plane"></i> @lang('fleet.submit') </button>
          </div>
        </div>
      </div>
    </div>
...
@section('script')
  ...
  <script>
    ...
    function save_booking() {
      ...
      $.ajax({
        url: "{{route('booking-quotation.store')}}",
        type: "POST",
        data: postData,
        ...
        success: function (res) {
          if(!res.success) {
            new PNotify({
              title: 'Error',
              text: "@lang('fleet.booking_quotation_created_successfully')",
              type: 'error'
            });
            return;
          }
          new PNotify({
            title: 'Success',
            text: "@lang('fleet.booking_quotation_updated_successfully')",
            type: 'success'
          });
